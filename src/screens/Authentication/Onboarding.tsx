...
export default function Onboarding({ }: Props) {
    ...
    return (
        <ScrollView contentContainerStyle={{
            ...
            <Image source={require("../../assets/images/pocket_logo.png")} alt='Pocket' style={{ width: Dimensions.get("window").height * 0.5, height: Dimensions.get("window").height * 0.5 }} />
            <Text textAlign="center" color={COLORS.primary} fontSize={1.5 * FONT_SIZE["xl"]} bold>Welcome to Pocket Wallet</Text>
